...
function aibvcs_section_rankings_field_aibvcs_ranking_max_elements_callback($args)
{
...
function aibvcs_section_rankings_field_aibvcs_ranking_show_scores_callback($args)
{
    $options = get_option(sprintf('%s_options', AIBVCS_MODULE_SLUG));
    $value = esc_attr(($args['data-value']));
    if (isset($options[ $args['label_for'] ]))
...
function aibvcs_section_rankings_field_aibvcs_ranking_show_women_callback($args)
{
    $options = get_option(sprintf('%s_options', AIBVCS_MODULE_SLUG));
    $value = esc_attr(($args['data-value']));
    if (isset($options[ $args['label_for'] ]))
...
function aibvcs_section_rankings_field_aibvcs_ranking_shorten_surnames_callback($args)
{
    $options = get_option(sprintf('%s_options', AIBVCS_MODULE_SLUG));
    $value = esc_attr(($args['data-value']));
    if (isset($options[ $args['label_for'] ]))
